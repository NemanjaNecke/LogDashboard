...
from logdashboard.data.log_parsers.GENERIC.msg_parser import (
    parse_big_xml,         # used for full XML files
    merge_transaction_info  # used within line-based logs
)
# Import specialized prom parser
from logdashboard.data.log_parsers.GENERIC.prom_parser import parse_prom_log
...
def process_inline_xml_from_line(message_fragment, file_iterator, transactions, source_file):
    ...
    try:
        ...
        from logdashboard.data.log_parsers.GENERIC.msg_parser import parse_single_xml

...
from logdashboard.services.controllers.DB_manager.db_controller import DBController
...
from logdashboard.ui.components.db_load.db_table_model import DBTableModel, DBSortFilterProxyModel
